...
(* For whatever reason, using byte instead of bv makes this compile two orders of magnitude faster. *)
...
(* The above definition feels slightly sketchy,
due to the several default behaviors upon operation failure.
...
Proof.
    ...
    - rewrite /ROM list_lookup_total_alt.
        ...
        have: is_Some w.
        {
            ...
            move: (bv_is_wf addr) => /bv_wf_in_range [pf1 /Z2Nat.inj_lt pf2].
            apply pf2.
            - exact pf1.
            - apply Z.lt_le_incl.
